...
#a
file = genfromtxt('data.csv', delimiter=',')
...
#c
x1=np.array(file[1::50,2])
y1=np.array(file[1::50,1])
plt.scatter(x1,y1)
plt.xlabel("masa(kg)")
plt.ylabel("visina(cm)")
...
print("Najmanja visina kod muskaraca:", men[1:,1].min(), "cm", "a kod zena:", women[1:,1].min(), "cm")
print("Najvisa visina kod muskaraca:", men[1:,1].max(), "cm", "a kod zena:", women[1:,1].max(), "cm")
print("Srednja visina kod muskaraca:", men[1:,1].mean(), "cm", "a kod zena:", women[1:,1].mean(), "cm")
